<?php
/**
 * Unit tests for Dukandaar_Bundle_Tools (issue #57: curated bundles / "complete the look").
 *
 ...
 * register_pack(), then dispatches through Dukandaar_Tool_Registry::instance()->dispatch()
